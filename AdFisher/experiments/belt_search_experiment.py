...
log_file = 'school_belt.gender.search.log.txt'
search_terms = ["what major should i study",
                "degree programs", "pick a college"]
...
def control_treatment(unit):
    unit.search_and_click('site_files/leather_belt.txt')

# Experimental Group treatment


def exp_treatment(unit):
    unit.search_and_click('site_files/gold_belt.txt')
...
adfisher.do_experiment(make_unit=make_browser, treatments=[control_treatment, exp_treatment],
                       ...
                       num_blocks=16, num_units=4, timeout=1400,
